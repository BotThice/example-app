            ...
            <div class="bg-white dark:bg-gray-800 overflow-hiddenshadow-sm sm:rounded-lg">
                <div class="p-6 dark:text-gray-100">
                    ...
                    <div class="mb-6 p-4 bg-gray-100 dark:bg-gray700 rounded-lg shadow-md">
                        ...
                        <div class="mt-4">
                            <h4 class="text-lg font-semibold mb-2 text-dark dark:text-gray-800">Emotions</h4>
                            <ul class="list-disc pl-5">
                                @foreach($entry->emotions as $emotion)
                                <li class="text-gray-700 dark:text-gray-600">
                        ...
                        <div class="mt-4 flex justify-end">
                            ...
                            <form method="POST" action="{{
                                route('diary.destroy', $entry) }}" id="delete-form-{{ $entry->id }}"
