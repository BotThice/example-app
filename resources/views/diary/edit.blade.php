                                ...
                                <div class="flex items-center mb-4">
                                    ...
                                    id="intensity_container_{{ $emotion->id }}">
                                        ...
                                        class="w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-700
                                            dark:text-gray-100 dark:border-gray-600 focus:ring-indigo-500 focus:borderindigo-500" 
                                        placeholder="Intensity" min="1" max="10"
                                        value="{{ old('intensity.' . $emotion->id, $diaryEntry->emotions->find($emotion->id)
                                        ->pivot->intensity ?? '') }}">
                                    </div>
                                </div>
                                @endforeach
