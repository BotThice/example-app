<section>
    <header>
        ...
        <h4 class="font-medium dark:text-blue-900">
            {{ __('Bio Information') }}
        </h4>
        ...
        text-xs text-white uppercase tracking-widest hover:bg-blue-500 active:bgblue-700 
        focus:outline-none focus:border-blue-700 focus:ring ring-blue-300
